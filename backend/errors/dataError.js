...
class ParameterError {
    constructor({parameter,value,message}) {
        ...
        this.value ={parameter,value} // e.g. {parameter:'Admission id',value:'ABC'}
...
}// End of BadRequestError class definition
...
module.exports = { ParameterError, BadRequestError, DuplicateError, DataError };